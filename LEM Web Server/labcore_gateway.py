...
#      "busy": true, "retry_after": 5, "pending": 137}
#
...
class LabCoreRefused(RuntimeError):
    ...
    def __init__(self, result, what: str = "", **extra) -> None:
        ...
        self.reason = refusal_reason(result) or "LabCore refused the write"
        self.what = what
        self.extra = extra
...
def refusal_reason(result) -> str:
    ...
    every unguarded helper in the codebase into a permanent error.
    """
