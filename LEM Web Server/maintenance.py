...
class MaintenanceManager:
    ...
    def _save_templates(self) -> None:
        ...
        # Clear CSV for any known box that no longer has any templates,
        # so deleted tasks don't reappear on server restart.
        for box_uid in list(self.box_dirs.keys()):
            if box_uid not in grouped:
                tpl_path, _ = self._paths_for(box_uid)
