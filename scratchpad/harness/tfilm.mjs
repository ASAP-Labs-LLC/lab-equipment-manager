/* tfilm.mjs — film.mjs pinned to the tier the judged frames are taken at.
 * The shared tool leaves the adaptive ladder to climb, which on a 13-second
 * capture means most of the sheet is shot at `floor` — where the shadow map is
 * 512 texels over the whole site and nothing this round is about can be seen.
 *
