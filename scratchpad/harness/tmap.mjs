/* tmap.mjs (a copy of gimapdump.mjs pinned to the ultra tier, because the
 * judged screenshots are taken there and at `floor` trains.js turns casting off
 * on purpose — dumping the map at the tier nobody judges answers nothing.)
 *
