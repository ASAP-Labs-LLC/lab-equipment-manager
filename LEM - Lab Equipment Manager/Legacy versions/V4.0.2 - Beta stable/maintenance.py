...
class MaintenanceManager:
    ...
    def update_task(self, task_id: str, data: dict) -> Optional[MaintenanceTemplate]:
        ...
        if "start_date" in data: 
            ...
            # Recalculate next due if status is UPCOMING? 
            # Simple approach: if we change start date or repeat, we might need to recalc next_due
            # But usually user edits "Next Due" directly or we assume manual control.
            # Let's trust values passed or keep existing logic.
