...
class MachineBoxItem(QGraphicsRectItem):
    def __init__(self, box: BoxConfig, view_only: bool = False):
        super().__init__()
        self.box = box
    ...
    def set_movable(self, movable: bool) -> None:
        self.setFlag(QGraphicsRectItem.ItemIsMovable, movable and not self.is_map_locked() and not self._view_only)
    ...
    def _apply_handle_visibility(self) -> None:
        unlocked = (not self.box.locked) and (not self.is_map_locked()) and (not self._view_only)
