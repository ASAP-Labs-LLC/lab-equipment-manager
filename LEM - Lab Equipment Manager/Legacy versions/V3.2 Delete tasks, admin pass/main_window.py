...
from PyQt5.QtWidgets import (
    ...
    QDialog, QMenu, QFileDialog, QMessageBox, QDockWidget, QWidget, QVBoxLayout,    QAbstractItemView, QPushButton, QTabWidget
)
...
class MaintenancePanel(QDockWidget):
    ...
    def add_maintenance_task(self, box: BoxConfig, name: str, kind: str,
                             start_date: datetime, repeat_value: int, repeat_unit: str) -> bool:
