...
def process_single_csv(input_csv, output_csv, config_folder):
    ...
    try:
        ...
        log_message('info', f"Processed single CSV: '{input_csv}'")
        return df
...
def process_multi_csv(input_folder, move_folder, output_folder, config_folder):
    ...
    try:
        ...
        for csv_file in csv_files:
            ...
            log_message('info', f"Processed and moved CSV file: '{csv_file}'")
        return dataframes
    except Exception as e:
