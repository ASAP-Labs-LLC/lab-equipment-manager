...
from PyQt5.QtWidgets import (
    ...
    QFileDialog, QMessageBox, QTextEdit, QListWidget, QListWidgetItem, QFormLayout, QCheckBox
)
    ...
    def update_parameters_fields(self, action_type):
        ...
        if action_type == "reorder":
            ...
            example_label = QLabel(
                ...
                "Example:\n"
                "C1 = C2 + C3\n"
                "C2 = C2 * 0.01  # Modifies column 2 in place\n"
                "NewColumn = C1 * 3.14\n"
                "Note: Indices are based on the column order after reordering.\n"
                "Numeric constants are written as usual."
            )
