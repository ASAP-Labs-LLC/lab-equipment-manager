...
class ConfigDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # --- Correction Factors ---
        self.correction_factors_checkbox = QCheckBox("Enable Correction Factors")
        self.correction_factors_checkbox.setChecked(self.config.get('correction_factors_enabled', True))
    ...
    def edit_data_actions(self):
        ...
        editor = PipelineEditor(existing_actions, config=self.config, parent=self)
        if editor.exec_():
            self.config['data'] = editor.get_pipeline()
    ...
    def save_config(self):
        ...
        self.config['correction_factors_enabled'] = self.correction_factors_checkbox.isChecked()
